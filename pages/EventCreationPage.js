...
class EventCreationPage extends BasePage {
  constructor(page) {
    super(page);
    ...
    this.requestCustomQuotes = 'xpath=//button[contains(text(),"Request custom quotes")]';
    this.eventNameInput = 'xpath=//input[contains(@placeholder,"Event event name")]';
    this.locationInput = 'xpath=//input[contains(@placeholder,"Enter location")]';
    this.burgersInput = 'xpath=//input[contains(@placeholder,"Burgers")]';
    this.createEventBtn = 'xpath=//button[contains(text(),"Create Event")]';
  ...
  await this.fill(this.burgersInput, 'Burgers');
  await this.page.waitForSelector('.Toastify__toast--success', { state: 'detached', timeout: 10000 });
  await this.waitForVisible(this.createEventBtn);
...
module.exports = EventCreationPage;
