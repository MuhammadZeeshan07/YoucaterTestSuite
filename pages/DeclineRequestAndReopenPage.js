...
class DeclineRequestAndReopenPage extends BasePage {
  constructor(page) {
    super(page);
    ...
    this.declineRequestBtn = 'xpath=//button[contains(text(),"Decline Request")]';
    this.selectReason = 'xpath=//input[contains(@value,"countTooLow")]';
    this.confirmBtn = 'xpath=//button[contains(text(),"Confirm")]';
    this.reopenEvent = 'xpath=//button[contains(text(),"Re-Open")]';
  ...
  async declineAndReopen(filePath, amount = '1234', comments = 'Test Comments') {
    ...
    await this.page.waitForTimeout(2000);
    await this.waitForVisible(this.declineRequestBtn);
    await this.click(this.declineRequestBtn);
    ...
    await this.waitForVisible(this.reopenEvent);
    await this.click(this.reopenEvent);
...
module.exports = DeclineRequestAndReopenPage;
