...
class AcceptQuotePage extends BasePage {
    ...
    await this.waitForVisible(this.stripeCardNo);
    await this.fill(this.stripeCardNo, '4242424242424242');
    await this.waitForVisible(this.stripeExp);
    await this.fill(this.stripeExp, '09 / 30');
    await this.waitForVisible(this.stripeCvc);
    ...
    await this.waitForVisible(this.checkoutLocality);
    await this.fill(this.checkoutLocality, 'test');
    await this.waitForVisible(this.checkoutPostal);
